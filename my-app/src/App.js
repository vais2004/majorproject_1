            ...
            <div className="col-md-4 d-flex justify-content-center mb-3 ">
              ...
              <div className="bg-light">
                <img
                  ...
                  onClick={() => navigate("/outfits/Men")}
                />
                <div>
                  <span className="badge text-bg-secondary px-2 py-2 fs-6 d-grid gap-2 mt-2">
                    Men
                  </span>
                </div>
              </div>
            ...
            <div className="col-md-4 d-flex justify-content-center mb-3">
              <div className="bg-light">
                <img
                  ...
                  alt="womens"
                  style={{ width: "150px", height: "150px" }}
                  onClick={() => navigate("/outfits/Women")}
                />
                <div>
                  <span className="badge text-bg-secondary px-2 py-2 fs-6 d-grid gap-2 mt-2">
                    Women
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  ...
                  <div className="carousel-caption d-none d-md-block">
                    ...
                    <p>
                      Gen Young Fashion from Rs.249 + Extra discount + Free
                      delivery
                    </p>
                  </div>
                </div>
