...
//                             +
//                           </button>
//                           <span className="fw-bold me-2">{product.quantity}</span>
//                           <button
...
//             <div className="col-12 col-lg-5 ms-lg-0">
//               <div className="bg-light p-4 rounded shadow-sm w-100">
...
//                     <span>
//                       ₹{(discountPrice() + (cartItems.length > 0 ? 99 : 0)).toFixed(2)}
//                     </span>
//                   </li>
//                 </ul>
...
// import Footer from "../components/Footer";
// import Header from "../components/Header";
// // Removed these imports because they don't exist in your reducer
// // import { addToCart, removeFromCart, updateQuantity } from "../features/cartReducer";
// import { useSelector, useDispatch } from "react-redux";
// import { Link, useNavigate } from "react-router-dom";
// import { addToWishlist, removeFromWishlist } from "../features/wishlistReducer";
// // Kept these async actions for cart operations
// import { addToCartAsync, removeFromCart, updateQuantityAsync } from '../features/cartReducer';
...
//                             className="btn btn-outline-primary btn-sm me-2"
//                             onClick={() =>
//                               dispatch(updateQuantityAsync({ id: product._id, quantity: product.quantity + 1 }))
//                             }
//                           >
//                             +
//                           </button>
